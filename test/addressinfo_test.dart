...
void main() {
  group('AddressInfo', () {
    ...
    test('Kiểm tra phương thức toJson', () {
      ...
      final expectedJsonString = '{"province":{"id":"01","name":"Hà Nội","level":"Thành phố"},"district":{"id":"002","name":"Hoàn Kiếm","level":"Quận","provinceId":"01"},"ward":{"id":"00079","name":"Phường Tràng Tiền","level":"Phường","districtId":"002","provinceId":"01"},"street":"Trần Quang Khải"}';
