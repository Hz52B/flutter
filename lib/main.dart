...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // Add this function to load location data
  Future<void> loadLocationData() async {
    // Load location data from JSON file
    final String locationData = await rootBundle.loadString('lib/assets/location_data.json');

    // Parse JSON string to Map
    final Map<String, dynamic> locationMap = json.decode(locationData) as Map<String, dynamic>;
  ...
  void initState() {
    super.initState();
    // Call loadLocationData when the widget is initialized
    loadLocationData();
  }
}
